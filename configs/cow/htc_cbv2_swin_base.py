...
evaluation = dict(metric=['bbox', 'segm'], interval=36)
samples_per_gpu=1
...
log_level = 'INFO'
load_from = '/data/user_data/pretrained/htc_cbv2_swin_base22k_patch4_window7_mstrain_400-1400_giou_4conv1f_adamw_20e_coco.pth'
resume_from = None
workflow = [('train', 1)]
work_dir = '/data/user_data/train_work_dirs/cbnet_swin_base'
