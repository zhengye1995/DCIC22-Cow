...
train_pipeline = [
    ...
    dict(type='CopyPaste', prob=0.5,
         copy_object_num=(1, 5),
         json_path='/data/raw_data/train_dataset/200/data.json',
         img_path='/data/raw_data/train_dataset/200/'),
    dict(
...
test_pipeline = [
    ...
    dict(
        ...
        img_scale=[(1300, 3000), (900, 3000), (600, 3000)],
        flip=True,
        transforms=[
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file='/data/raw_data/train_dataset/200/data.json',
        img_prefix='/data/raw_data/train_dataset/200/',
        seg_prefix='/data/raw_data/train_dataset/200/seg_map/',
...
evaluation = dict(metric=['bbox', 'segm'], interval=48)
samples_per_gpu=1
...
log_level = 'INFO'
load_from = '/data/user_data/pretrained/htc_cbv2_swin_large22k_patch4_window7_mstrain_400-1400_giou_4conv1f_adamw_1x_coco.pth'
resume_from = None
workflow = [('train', 1)]
work_dir = '/data/user_data/train_work_dirs/cbnet_swin_large'
