...
model = dict(
    ...
    roi_head=dict(
        type='HybridTaskCascadeRoIHeadOnlyMask',
        interleaved=True,
        mask_info_flow=True,
...
log_level = 'INFO'
load_from = 'data/pretrained/htc_cbv2_swin_large22k_patch4_window7_mstrain_400-1400_giou_4conv1f_adamw_1x_coco.pth'
resume_from = None
workflow = [('train', 1)]
work_dir = 'work_dirs/cbnet_swin_large_36ep_bs8_copy_paste_cutout_PhotoMetricDistortion_4gpu_masklossx3_large_scale'
