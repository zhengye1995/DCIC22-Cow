...
class DoubleHybridTaskCascadeRoIHead(DoubleCascadeRoIHead):
    ...
    def __init__(self,
                 ...
                 mask_info_flow=True,
                 **kwargs):
        super(DoubleHybridTaskCascadeRoIHead,
    ...
    def _bbox_forward(self, stage, x, rois, semantic_feat=None):
        ...
        if self.with_semantic and 'bbox' in self.semantic_fusion:
            bbox_semantic_feat = self.semantic_roi_extractor([semantic_feat],
                                                             rois)
            if bbox_semantic_feat.shape[-2:] != bbox_cls_feats.shape[-2:]:
                bbox_semantic_feat = adaptive_avg_pool2d(
                    bbox_semantic_feat, bbox_cls_feats.shape[-2:])
            bbox_cls_feats += bbox_semantic_feat
            bbox_reg_feats += bbox_reg_feats
